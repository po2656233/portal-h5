  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'm1',
      sender: 'support',
      text: `欢迎来到香蕉视频 24小时金牌专属客服中心！我是您的老司机秘书【小美】。👩‍💼\n\n请问今天有什么可以帮您的呢？您可以咨询：\n1️⃣ 充值后未到账怎么办？\n2️⃣ 如何升级永久无限看VIP？\n3️⃣ 棋牌游戏钱包额度如何转换？\n4️⃣ 推广好友如何抽取高达1.2%无上限佣金？`,
      time: '刚刚'
    }
  ]);
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (question.includes('充值') || question.includes('到账') || question.includes('钱')) {
        replyText = `💰 **【充值未到账处理指南】**\n\n请您放心，香蕉视频采用云端数字加密双通道入账。由于网络延迟或区块链拥堵，部分订单可能需要 1-3 分钟确认。\n\n请提供您的**充值单号**或**支付凭证截图**发给小美，小美会立刻为您申请极速双倍补单！`;
      ...
      } else if (question.includes('转换') || question.includes('余额') || question.includes('棋牌')) {
